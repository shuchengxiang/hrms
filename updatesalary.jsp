...
<form name="stipendForm" method="post" action="SalaryServlet?method=salaryUpdate" onSubmit="return stipendValidate();" >
<div class="MainDiv">
  ...
  <tr>
    <td class="CPanel">
		...
		<tr><td align="left">
			...
			<input type="reset" value="返回" onclick="javascript:history.back()" class="button"/>
			</td>
		</tr>
		<tr>
			<td width="100%">
