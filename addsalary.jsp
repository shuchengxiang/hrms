...
<form name="stipendForm" method="post" action="SalaryServlet?method=salaryAdd" onSubmit="return stipendValidate();" >
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  ...
  <tr>
    <td class="CPanel">
		...
		<input type="reset" value="关闭" onclick="document.location.href='mainfra.html'" class="button"/>
		</td></tr>
